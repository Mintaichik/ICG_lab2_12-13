...
GLuint gWVPLocation; //указатель для доступа к в матрице, представленной в виде uniform-переменной внутри шейдера.
...
static void RenderSceneCB()
{
	...
	//Вектор вверх для простоты положительный Y. Мы назначаем это в класс конвейера, а об остальном он позаботится сам.
